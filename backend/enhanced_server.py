...
from evidence_processing_enhanced import router as evidence_processing_router
...
from api.modules.diversos.calc_universal_complete import router as calc_universal_router
from api.modules.diversos.calc_final_19 import router as calc_final_router
...
from api.modules.pericia.cloud_forensics_complete import router as cloud_forensics_complete_router
from api.modules.pericia.crypto_forensics import router as crypto_forensics_router
...
app.include_router(calc_universal_router)
app.include_router(calc_final_router)
...
app.include_router(clientes_dossie_router)
app.include_router(sync_judicial_router)
app.include_router(sync_judicial_complete_router)
