...
class GestaoFinanceiraEngine(BaseEngine):
    def __init__(self):
        super().__init__("gestao/gestao_financeira")
    
    async def execute(self, input_data: Dict, logger) -> Dict[str, Any]:
        logger.log("ENGINE_START", {"module": "gestao/gestao_financeira"})
