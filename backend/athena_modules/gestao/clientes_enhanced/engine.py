...
class ClientesEnhancedEngine(BaseEngine):
    def __init__(self):
        super().__init__("gestao/clientes_enhanced")
    
    async def execute(self, input_data: Dict, logger) -> Dict[str, Any]:
        logger.log("ENGINE_START", {"module": "gestao/clientes_enhanced"})
