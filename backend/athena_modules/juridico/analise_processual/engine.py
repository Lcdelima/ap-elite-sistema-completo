...
class AnaliseProcessualEngine(BaseEngine):
    def __init__(self):
        super().__init__("juridico/analise_processual")
    
    async def execute(self, input_data: Dict, logger) -> Dict[str, Any]:
        logger.log("ENGINE_START", {"module": "juridico/analise_processual"})
...
async def execute(input_data: Dict, logger) -> Dict[str, Any]:
    engine = AnaliseProcessualEngine()
