...
class AnaliseErbsEngine(BaseEngine):
    def __init__(self):
        super().__init__("pericia/analise_erbs")
    
    async def execute(self, input_data: Dict, logger) -> Dict[str, Any]:
        logger.log("ENGINE_START", {"module": "pericia/analise_erbs"})
