...
class RagSystemEngine(BaseEngine):
    def __init__(self):
        super().__init__("tecnologia/rag_system")
    
    async def execute(self, input_data: Dict, logger) -> Dict[str, Any]:
        logger.log("ENGINE_START", {"module": "tecnologia/rag_system"})
