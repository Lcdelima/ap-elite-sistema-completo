...
### Passo 1: Login
1. Acesse: https://elite-solution.preview.emergentagent.com/login
...
2. Ou acesse diretamente: https://elite-solution.preview.emergentagent.com/admin/athena

### Passo 3: Acessar Análise Processual
1. Na tela Athena, procure o card **"Análise Processual Pro"**
2. Ou acesse diretamente: https://elite-solution.preview.emergentagent.com/athena/process-analysis
...
### Base URL
```
https://elite-solution.preview.emergentagent.com/api/athena/process-analysis
```
...
2. Acessar: https://elite-solution.preview.emergentagent.com/athena/process-analysis
...
```bash
# Listar análises
curl https://elite-solution.preview.emergentagent.com/api/athena/process-analysis

# Criar análise
curl -X POST https://elite-solution.preview.emergentagent.com/api/athena/process-analysis \
