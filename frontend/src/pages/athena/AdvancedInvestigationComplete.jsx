...
const AdvancedInvestigationComplete = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/advancedinvestigationcomplete/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/advancedinvestigationcomplete/create`, {
        collection: 'advancedinvestigationcomplete',
        data: formData
      });
  ...
  return (
    <UniversalModuleLayout
      title="Advanced Investigation Complete"
