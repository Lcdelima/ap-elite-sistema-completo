...
const CommunicationsEnhanced = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/communicationsenhanced/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/communicationsenhanced/create`, {
        collection: 'communicationsenhanced',
        data: formData
      });
