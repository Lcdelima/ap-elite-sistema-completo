...
const EvidenceAnalysis = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/evidenceanalysis/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/evidenceanalysis/create`, {
        collection: 'evidenceanalysis',
        data: formData
      });
