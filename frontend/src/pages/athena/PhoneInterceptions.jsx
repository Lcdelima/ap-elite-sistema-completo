...
import { Phone, Plus, AlertTriangle, CheckCircle } from 'lucide-react';
...
const PhoneInterceptions = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/interceptions/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/interceptions/create`, {
