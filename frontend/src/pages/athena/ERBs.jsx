...
import { Radio, Plus, AlertTriangle, CheckCircle } from 'lucide-react';
...
const ERBs = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/erbs/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/erbs/create`, {
        collection: 'erbs',
        data: formData
      });
  ...
  return (
    <UniversalModuleLayout
      title="ERBs - Estações Rádio Base"
