...
const PhoneInterceptionsPro = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/phoneinterceptionspro/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/phoneinterceptionspro/create`, {
        collection: 'phoneinterceptionspro',
        data: formData
      });
...
export default PhoneInterceptionsPro;
