...
const DocumentGeneratorComplete = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/documentgeneratorcomplete/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/documentgeneratorcomplete/create`, {
        collection: 'documentgeneratorcomplete',
        data: formData
      });
  ...
  return (
    <UniversalModuleLayout
      title="Document Generator Complete"
...
export default DocumentGeneratorComplete;
