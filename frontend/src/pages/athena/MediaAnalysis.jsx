...
const MediaAnalysis = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/mediaanalysis/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/mediaanalysis/create`, {
        collection: 'mediaanalysis',
        data: formData
      });
