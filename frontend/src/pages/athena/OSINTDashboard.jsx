...
import { Globe, Plus, AlertTriangle, CheckCircle } from 'lucide-react';
...
const OSINTDashboard = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/osint/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/osint/create`, {
        collection: 'osint',
        data: formData
      });
