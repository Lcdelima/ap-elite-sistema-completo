...
import { Brain, Plus, AlertTriangle, CheckCircle } from 'lucide-react';
...
const RAGSystem = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/rag/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/rag/create`, {
        collection: 'rag',
        data: formData
      });
