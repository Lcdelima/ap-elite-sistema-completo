...
const ProcessesStandardized = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/processesstandardized/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/processesstandardized/create`, {
        collection: 'processesstandardized',
        data: formData
      });
