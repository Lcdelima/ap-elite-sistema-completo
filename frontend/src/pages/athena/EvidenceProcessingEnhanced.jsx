...
const EvidenceProcessingEnhanced = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/evidenceprocessingenhanced/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/evidenceprocessingenhanced/create`, {
        collection: 'evidenceprocessingenhanced',
        data: formData
      });
  ...
  return (
    <UniversalModuleLayout
      title="Evidence Processing Enhanced"
