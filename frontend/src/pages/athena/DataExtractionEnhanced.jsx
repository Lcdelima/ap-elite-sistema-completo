...
const DataExtractionEnhanced = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/dataextractionenhanced/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/dataextractionenhanced/create`, {
        collection: 'dataextractionenhanced',
        data: formData
      });
  ...
  return (
    <UniversalModuleLayout
      title="Data Extraction Enhanced"
