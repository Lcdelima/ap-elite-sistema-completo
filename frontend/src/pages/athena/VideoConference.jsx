...
import { Video, Plus, AlertTriangle, CheckCircle } from 'lucide-react';
...
const VideoConference = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/meetings/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/meetings/create`, {
        collection: 'meetings',
        data: formData
      });
