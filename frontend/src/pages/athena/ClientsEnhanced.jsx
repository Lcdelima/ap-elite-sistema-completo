...
const ClientsEnhanced = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/clientsenhanced/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/clientsenhanced/create`, {
        collection: 'clientsenhanced',
        data: formData
      });
