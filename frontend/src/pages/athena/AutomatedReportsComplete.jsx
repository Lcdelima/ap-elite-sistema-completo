...
const AutomatedReportsComplete = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/automatedreportscomplete/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/automatedreportscomplete/create`, {
        collection: 'automatedreportscomplete',
        data: formData
      });
  ...
  return (
    <UniversalModuleLayout
      title="Automated Reports Complete"
