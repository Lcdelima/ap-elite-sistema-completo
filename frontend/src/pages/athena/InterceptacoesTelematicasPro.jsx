...
const InterceptacoesTelematicasPro = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/interceptacoestelematicaspro/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/interceptacoestelematicaspro/create`, {
        collection: 'interceptacoestelematicaspro',
        data: formData
      });
  ...
  return (
    <UniversalModuleLayout
      title="Interceptacoes Telematicas Pro"
