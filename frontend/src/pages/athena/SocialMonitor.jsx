...
import { Share2, Plus, AlertTriangle, CheckCircle } from 'lucide-react';
...
const SocialMonitor = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/social/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/social/create`, {
        collection: 'social',
        data: formData
      });
