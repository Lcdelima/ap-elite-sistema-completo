...
const ForensicsEnhanced = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/forensicsenhanced/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/forensicsenhanced/create`, {
        collection: 'forensicsenhanced',
        data: formData
      });
