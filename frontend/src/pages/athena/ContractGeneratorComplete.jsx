...
const ContractGeneratorComplete = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/contractgeneratorcomplete/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/contractgeneratorcomplete/create`, {
        collection: 'contractgeneratorcomplete',
        data: formData
      });
  ...
  return (
    <UniversalModuleLayout
      title="Contract Generator Complete"
