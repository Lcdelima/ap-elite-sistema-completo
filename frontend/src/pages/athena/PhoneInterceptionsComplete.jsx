...
const PhoneInterceptionsComplete = () => {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${BACKEND_URL}/api/athena/phoneinterceptionscomplete/list`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/api/athena/phoneinterceptionscomplete/create`, {
        collection: 'phoneinterceptionscomplete',
        data: formData
      });
